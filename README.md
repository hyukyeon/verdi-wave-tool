...
# 4. By default, TCL is always regenerated
./run_verdi lte_crs topsim_lte /path/to/sim.fsdb
```
...
If the output TCL already exists it is regenerated by default.
Use `--reuse` to skip regeneration and use the existing file.
